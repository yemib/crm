...
class  InstallationStart  extends SearchableComponent
{
    ...
    public function render()
    {
        ...
        return view('livewire.installation-start', compact('invoices', 'statusCount', 'customer', 'invoiceStatus' , 'status' ));
    ...
    public function searchInvoices()
    {
        ...
        if(    $assign   >  0   &&  $manage ==  0  ){
          ...
          $this->getQuery()->where('job_done'  , $this->status);
