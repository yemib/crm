...
class LeadSourceController extends AppBaseController
{
    ...
    public function store(CreateLeadSourceRequest $request)
    {
        ...
        return $this->sendResponse($leadSource, __('messages.lead_source.lead_source_saved_successfully'));
    }
    ...
    public function update(UpdateLeadSourceRequest $request, LeadSource $leadSource)
    {
        ...
        return $this->sendSuccess(__('messages.lead_source.lead_source_updated_successfully'));
    }
    ...
    public function destroy(LeadSource $leadSource)
    {
        ...
        if ($leadSourceId) {
            return $this->sendError(__('messages.lead_source.lead_source_used_somewhere'));
        }
