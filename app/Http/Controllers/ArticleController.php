...
class ArticleController extends AppBaseController
{
    ...
    public function index()
    {
        ...
        $groupArr = ArticleGroup::orderBy('group_name', 'asc')->pluck('group_name', 'id')->toArray();
    ...
    public function store(CreateArticleRequest $request)
    {
        ...
        Flash::success(__('messages.article.article_saved_successfully'));
    ...
    public function update(UpdateArticleRequest $request, Article $article)
    {
        ...
        Flash::success(__('messages.article.article_updated_successfully'));
    ...
    public function activeDeActiveDisabled($id)
    {
        ...
        return $this->sendSuccess('Article status updated successfully.');
    }
