...
class AnnouncementController extends AppBaseController
{
    ...
    {
        if ($request->ajax()) {
            return DataTables::of((new AnnouncementDataTable())->get($request->only([
                'status', 'showToClient',
            ])))->make(true);
        }
    ...
    public function store(CreateAnnouncementRequest $request)
    {
        ...
        return $this->sendSuccess(__('messages.announcement.announcement_saved_successfully'));
    }
    ...
    public function update(UpdateAnnouncementRequest $request, Announcement $announcement)
    {
        ...
        return $this->sendSuccess(__('messages.announcement.announcement_updated_successfully'));
    }
