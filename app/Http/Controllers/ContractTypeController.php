...
class ContractTypeController extends AppBaseController
{
    ...
    public function store(CreateContractTypeRequest $request)
    {
        ...
        return $this->sendResponse($contractType, __('messages.contract_type.contract_type_saved_successfully'));
    }
    ...
    public function update(ContractType $contractType, UpdateContractTypeRequest $request)
    {
        ...
        return $this->sendSuccess(__('messages.contract_type.contract_type_updated_successfully'));
    }
    ...
    public function destroy(ContractType $contractType)
    {
        ...
        if ($contractTypeId) {
            return $this->sendError(__('messages.contract_type.contract_type_used_somewhere_else'));
        }
