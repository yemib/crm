...
class ArticleGroupController extends AppBaseController
{
    ...
    public function store(CreateArticleGroupRequest $request)
    {
        ...
        return $this->sendResponse($articleGroup, __('messages.article_group.article_group_saved_successfully'));
    }
    ...
    public function update(UpdateArticleGroupRequest $request, ArticleGroup $articleGroup)
    {
        ...
        return $this->sendSuccess(__('messages.article_group.article_group_updated_successfully'));
    }
    ...
    public function destroy(ArticleGroup $articleGroup)
    {
        ...
        if ($articleGroupId) {
            return $this->sendError(__('messages.article_group.article_group_used_somewhere_else'));
        }
