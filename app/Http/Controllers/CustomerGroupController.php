...
class CustomerGroupController extends AppBaseController
{
    ...
    public function update(CustomerGroup $customerGroup, UpdateCustomerGroupRequest $request)
    {
        ...
        try {
            ...
            return $this->sendSuccess(__('messages.customer_group.customer_group_updated_successfully'));
        } catch (Throwable $e) {
            DB::rollback();
            throw $e;
        }
    ...
    public function store(CreateCustomerGroupRequest $request)
    {
        ...
        try {
            ...
            return $this->sendResponse($customerGroup, __('messages.customer_group.customer_group_saved_successfully'));
        } catch (Throwable $e) {
            DB::rollback();
            throw $e;
        }
