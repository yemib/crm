...
class TaskController extends AppBaseController
{
    ...
    public function store(CreateTaskRequest $request)
    {
        ...
        Flash::success(__('messages.task.task_saved_successfully'));
    ...
    public function show(Task $task)
    {
        ...
        return view("tasks.views.$groupName", compact('task', 'data', 'comments', 'groupName'));
    }
    ...
    public function update(Task $task, UpdateTaskRequest $request)
    {
        ...
        Flash::success(__('messages.task.task_updated_successfully'));
    ...
    public function changeStatus(Task $task, $status)
    {
        ...
        return $this->sendSuccess(__('messages.task.task_status_updated_successfully'));
    }
