        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <a href="javascript:void(0)" class="btn btn-primary form-btn mr-2 float-right-mobile text-nowrap"
                   id="ticketContactBtn">
                    <span id="ticketContact"><?php echo e(__('messages.ticket.ticket_without_contact')); ?></span> &nbsp;<i
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\websites\crm\crm\resources\views/tickets/create.blade.php ENDPATH**/ ?>