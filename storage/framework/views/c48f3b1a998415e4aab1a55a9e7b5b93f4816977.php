                ...
                <div class="row" id="addressForm">
                    ...
                    <div class="form-group col-sm-12 col-md-6">
                        <div class="form-group col-sm-12">
                            ...
                            <?php echo e(Form::select('country[]', $data['countries'],(isset($addresses[0]->country) )?$addresses[0]->country:null,
                    ...
                    <div class="form-group col-sm-12 col-md-6">
                        ...
                        <select name="city[]"  class="form-control"  id="billCity">
                            <?php if(isset($addresses[0]->city)): ?>  <option> <?php echo e($addresses[0]->city); ?></option> <?php endif; ?>
                    ...
                    <div class="form-group col-sm-12 col-md-6">
                        ...
                        <?php echo e(Form::text('zip_code[]', isset($addresses[0]->zip_code) ?
                    ...
                    <div class="row" id="addressForm">
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            <div class="form-group col-sm-12">
                                ...
                                <?php echo e(Form::select('country[]', $data['countries'],(isset($addresses[1]->country) )?$addresses[1]->country:null,
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                         ...
                         <select  name="city[]"  id="shipCity" class = 'form-control city'>
                          <?php if(isset($addresses[1]->city)): ?>  <option> <?php echo e($addresses[1]->city); ?> </option>    <?php endif; ?>
...
<?php /**PATH G:\websites\crm\crm\resources\views/estimates/address_modal.blade.php ENDPATH**/ ?>