                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-0">
                        ...
                        <div class="form-group col-sm-12 mb-0">
                            ...
                            <input  id="predefined_value<?php echo e($key); ?>" placeholder="<?php echo e($field->reply_name); ?>" name="predefined_value[]" value=""
...
<?php /**PATH C:\websites\crm\crm\resources\views/expense_categories/edit_modal.blade.php ENDPATH**/ ?>