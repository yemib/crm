                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <br />
                                            <input data-dismiss="modal" onclick="pauseTimer()" style="display:none"
                                                id="pausebutton" class="btn btn-primary" type="submit"
                                                value="Pause Installation" />

                                            <input data-dismiss="modal" onclick="endTimer()" style="display: none"
                                                id="endbutton" class="btn btn-danger" type="submit"
                                                value="End Installation" />
                            ...
                            <div style="padding: 20px">
                                ...
                                <table id="table_note" border="1" class="table">
                                    ...
                                    <?php $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e(date_format($note->created_at, 'd-M-Y')); ?></td>
                                            <td style="width: 50%"><?php echo e($note->note); ?></td>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        function pauseTimer() {
            ...
            $.ajax({
                url: '/admin/progress/<?php echo e($invoice->id); ?>/2?note=' + message,
                type: 'GET',
                ...
                success: function(data) {
                    ...
                    if (message.length != 0) {
                        $output_message = `<tr><td><?php echo e(date('d-M-Y')); ?></td> <td style="width:50%">` + message + `</td>
                    <td>Pause Installation Note</td>
        ...
        function endTimer() {
            ...
            $.ajax({
                url: '/admin/progress/<?php echo e($invoice->id); ?>/4?note=' + message,
                type: 'GET',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\websites\crm\crm\resources\views/start_installation/create.blade.php ENDPATH**/ ?>