    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo e(__('messages.customer_group.new_customer_group')); ?></h5>
                <button type="button" aria-label="Close" class="close" data-dismiss="modal">×</button>
            </div>
            <?php echo e(Form::open(['id'=>'addCustomerGroupForm'])); ?>
...
<?php /**PATH G:\websites\crm\crm\resources\views/customers/customer_group_modal.blade.php ENDPATH**/ ?>