...
} elseif ($_instance->childHasBeenRendered('ay4BtLG')) {
    $componentId = $_instance->getRenderedChildComponentId('ay4BtLG');
    $componentTag = $_instance->getRenderedChildComponentTagName('ay4BtLG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ay4BtLG');
} else {
    $response = \Livewire\Livewire::mount('installation-start'  ,  ['status' => $status]);
    $html = $response->html();
    $_instance->logRenderedChild('ay4BtLG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\websites\crm\crm\resources\views/start_installation/index.blade.php ENDPATH**/ ?>