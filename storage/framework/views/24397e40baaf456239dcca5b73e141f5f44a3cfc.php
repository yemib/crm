<?php $__env->startSection('title'); ?>
    <?php echo e(__('messages.ticket.edit_ticket')); ?>
...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="section-header">
            <h1><?php echo e(__('messages.ticket.edit_ticket')); ?></h1>
        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-body">
                    <?php echo e(Form::model($ticket, ['route' => ['ticket.update', $ticket->id], 'id' => 'editTicket' ,'method' => 'put', 'files' => true])); ?>


                    <?php echo $__env->make('tickets.edit_fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('tickets.ticket_status_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        let ticketAttachmentUrl = "<?php echo e(url('admin/ticket-attachment-delete')); ?>";
    </script>
    <script src="<?php echo e(mix('assets/js/tickets/create-edit.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\websites\crm\crm\resources\views/tickets/edit.blade.php ENDPATH**/ ?>