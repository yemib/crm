    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo e(__('messages.product_group.add_new_product_group')); ?></h5>
                <button type="button" aria-label="Close" class="close" data-dismiss="modal">×</button>
            </div>
            <?php echo e(Form::open(['id' => 'editProductGroupForm'])); ?>
...
<?php /**PATH C:\websites\crm\crm\resources\views/products/edit_product_group_modal.blade.php ENDPATH**/ ?>