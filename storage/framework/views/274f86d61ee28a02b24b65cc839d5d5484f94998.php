...
} elseif ($_instance->childHasBeenRendered('F9g9zCU')) {
    $componentId = $_instance->getRenderedChildComponentId('F9g9zCU');
    $componentTag = $_instance->getRenderedChildComponentTagName('F9g9zCU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('F9g9zCU');
} else {
    $response = \Livewire\Livewire::mount('estimates');
    $html = $response->html();
    $_instance->logRenderedChild('F9g9zCU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\websites\crm\crm\resources\views/estimates/index.blade.php ENDPATH**/ ?>