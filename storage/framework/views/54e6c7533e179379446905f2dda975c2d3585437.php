...
} elseif ($_instance->childHasBeenRendered('xrnDR5v')) {
    $componentId = $_instance->getRenderedChildComponentId('xrnDR5v');
    $componentTag = $_instance->getRenderedChildComponentTagName('xrnDR5v');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xrnDR5v');
} else {
    $response = \Livewire\Livewire::mount('installation'  ,  ['status' => $status]);
    $html = $response->html();
    $_instance->logRenderedChild('xrnDR5v', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\websites\crm\crm\resources\views/installation/index.blade.php ENDPATH**/ ?>