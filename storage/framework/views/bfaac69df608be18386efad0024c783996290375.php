...
} elseif ($_instance->childHasBeenRendered('0DjgRB3')) {
    $componentId = $_instance->getRenderedChildComponentId('0DjgRB3');
    $componentTag = $_instance->getRenderedChildComponentTagName('0DjgRB3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0DjgRB3');
} else {
    $response = \Livewire\Livewire::mount('invoices'  ,  ['job' => $job]);
    $html = $response->html();
    $_instance->logRenderedChild('0DjgRB3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('hMFkso8')) {
    $componentId = $_instance->getRenderedChildComponentId('hMFkso8');
    $componentTag = $_instance->getRenderedChildComponentTagName('hMFkso8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hMFkso8');
} else {
    $response = \Livewire\Livewire::mount('invoices' , ['job' => 0]);
    $html = $response->html();
    $_instance->logRenderedChild('hMFkso8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\websites\crm\crm\resources\views/invoices/index.blade.php ENDPATH**/ ?>