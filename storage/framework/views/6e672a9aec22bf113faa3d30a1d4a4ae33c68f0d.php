...
} elseif ($_instance->childHasBeenRendered('bfaYlNl')) {
    $componentId = $_instance->getRenderedChildComponentId('bfaYlNl');
    $componentTag = $_instance->getRenderedChildComponentTagName('bfaYlNl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bfaYlNl');
} else {
    $response = \Livewire\Livewire::mount('members');
    $html = $response->html();
    $_instance->logRenderedChild('bfaYlNl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\websites\crm\crm\resources\views/members/index.blade.php ENDPATH**/ ?>