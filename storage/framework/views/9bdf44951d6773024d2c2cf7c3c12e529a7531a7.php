...
} elseif ($_instance->childHasBeenRendered('1LvuT41')) {
    $componentId = $_instance->getRenderedChildComponentId('1LvuT41');
    $componentTag = $_instance->getRenderedChildComponentTagName('1LvuT41');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1LvuT41');
} else {
    $response = \Livewire\Livewire::mount('warranty'  ,  ['status' => $status]);
    $html = $response->html();
    $_instance->logRenderedChild('1LvuT41', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\websites\crm\crm\resources\views/assigned_warranty/index.blade.php ENDPATH**/ ?>