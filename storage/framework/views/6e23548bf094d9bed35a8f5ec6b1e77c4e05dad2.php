<div class="card-body">
    ...
    <div class="row">
        <div class="form-group col-lg-12 col-md-12 col-sm-12 overflow-section">
            <?php echo $__env->make('invoices.items_table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
...
<?php /**PATH C:\websites\crm\crm\resources\views/estimates/fields.blade.php ENDPATH**/ ?>