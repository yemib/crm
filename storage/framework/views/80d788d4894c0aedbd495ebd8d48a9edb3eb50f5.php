        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('installation-start'  ,  ['status' => $status])->html();
} elseif ($_instance->childHasBeenRendered('IlAYm4V')) {
    $componentId = $_instance->getRenderedChildComponentId('IlAYm4V');
    $componentTag = $_instance->getRenderedChildComponentTagName('IlAYm4V');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IlAYm4V');
} else {
    $response = \Livewire\Livewire::mount('installation-start'  ,  ['status' => $status]);
    $html = $response->html();
    $_instance->logRenderedChild('IlAYm4V', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\websites\crm\crm\resources\views/start_installation/index.blade.php ENDPATH**/ ?>