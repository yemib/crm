...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="section-header">
            <h1><?php if(isset($title)): ?> <?php echo e($title); ?>   <?php endif; ?> Warranty </h1>
        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('warranty'  ,  ['status' => $status])->html();
} elseif ($_instance->childHasBeenRendered('Kw4FN6c')) {
    $componentId = $_instance->getRenderedChildComponentId('Kw4FN6c');
    $componentTag = $_instance->getRenderedChildComponentTagName('Kw4FN6c');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Kw4FN6c');
} else {
    $response = \Livewire\Livewire::mount('warranty'  ,  ['status' => $status]);
    $html = $response->html();
    $_instance->logRenderedChild('Kw4FN6c', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\websites\crm\crm\resources\views/assigned_warranty/index.blade.php ENDPATH**/ ?>