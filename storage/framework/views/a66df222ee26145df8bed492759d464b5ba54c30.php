...
} elseif ($_instance->childHasBeenRendered('sOiziRZ')) {
    $componentId = $_instance->getRenderedChildComponentId('sOiziRZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('sOiziRZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sOiziRZ');
} else {
    $response = \Livewire\Livewire::mount('tickets');
    $html = $response->html();
    $_instance->logRenderedChild('sOiziRZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\websites\crm\crm\resources\views/tickets/index.blade.php ENDPATH**/ ?>