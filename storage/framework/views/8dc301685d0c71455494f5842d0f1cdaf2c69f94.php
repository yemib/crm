            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <?php echo e(Form::text('title', null, ['class' => 'form-control', 'required', 'id' => 'editTitle','autocomplete' => 'off','placeholder'=> __('messages.products.title')])); ?>
                    ...
                    <div class="form-group col-sm-12 col-lg-6 col-md-12">
                       ...
                       <input  id="editProductCode"  name="product_code"    class="form-control"/>
                    </div>
...
<?php /**PATH G:\websites\crm\crm\resources\views/products/edit_modal.blade.php ENDPATH**/ ?>