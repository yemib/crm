                            ...
                            <div class="d-table w-100">
                                <div>
                                    <i class="fas fa-street-view"></i><span
                                            class="text-decoration-none"> <?php echo e(html_entity_decode(Str::limit($invoice->customer->company_name,15))); ?></span>
                                </div>
                                ...
                                <a  target="_blank" href="<?php echo e(route('assign.project.index'  ,  $invoice->id  )); ?>">
...
<?php /**PATH G:\websites\crm\crm\resources\views/livewire/installation.blade.php ENDPATH**/ ?>