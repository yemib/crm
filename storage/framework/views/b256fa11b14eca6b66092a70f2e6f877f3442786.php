                ...
                (p = $(".total-numbers").text()),
                    $(".items-container>tr").each(function () {
                        (m = []),
                            ...
                            (q   = $(this).find(".warranty_period select").val() ),
                            $.each(
                            ...
                            s.append("itemsArr[" + u + "][warranty_period]", q),
                            u++;
                    }),
                ...
                (l = $(".total-numbers").text()),
                    $(".items-container>tr").each(function () {
                        ...
                        (u = []),
                            ...
                            s.append("itemsArr[" + h + "][warranty_period]", y),
                            h++;
                    }),
                    $("#taxesListTable>tr").each(function () {
...
<?php /**PATH G:\websites\crm\crm\resources\views/invoices/invoice_script.blade.php ENDPATH**/ ?>