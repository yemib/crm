...
let tableName = $('#productGroupsTable');
$(tableName).DataTable({
    oLanguage: {
    ...
    columns: [
        ...
        },
        {
            data: function (row) {
                let data = [{ 'id': row.id }];
                return prepareTemplateRender('#productGroupActionTemplate',
                    data);
            }, name: 'id',
        },
    ],
...
$(document).on('click', '.edit-btn', function (event) {
    let productGroupId = $(event.currentTarget).data('id');
...
$(document).on('click', '.delete-btn', function (event) {
    let productGroupId = $(event.currentTarget).data('id');
    deleteItem(route('product-groups.destroy', productGroupId),
        '#productGroupsTable',
        Lang.get('messages.common.product_group'));
});
