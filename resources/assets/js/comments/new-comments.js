...
function addCommentSection (comment) {
    ...
    if (comment.added_by == authId) {
        icons = '                    <a class="user__icons del-comment d-none task-comment-delete" title="'+ Lang.get('messages.common.delete') +'" data-id="' +
            id + '"><i class="fas fa-trash ml-0 card-delete-icon"></i></a>\n' +
            '                    <a class="user__icons edit-comment d-none task-comment-edit" title="'+ Lang.get('messages.common.edit') +'" data-id="' +
            id +
