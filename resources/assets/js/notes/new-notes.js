...
function addNoteSection (note) {
    ...
    if (note.added_by == authId) {
        icons = '                    <a class="user__icons del-note d-none task-comment-delete" title="'+ Lang.get('messages.common.delete') +'" data-id="' +
            id + '"><i class="fas fa-trash ml-0 card-delete-icon"></i></a>\n' +
            '                    <a class="user__icons edit-note d-none task-comment-edit" title="'+ Lang.get('messages.common.edit') +'" data-id="' +
            id +
