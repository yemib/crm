                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 creditNoteDetail">
                        ...
                        <div class="invoice-date d-table float-right">
                            <div class="d-table-row">
                                ...
                                <div class="d-table-cell">{{ !empty($creditNote->credit_note_date) ? Carbon\Carbon::parse($creditNote->credit_note_date)->translatedFormat('jS M, Y') : __('messages.common.n/a')}}</div>
                            </div>
