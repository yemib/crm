    ...
    <div class="row">
        ...
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('credit_note_number', isset($creditNote->credit_note_number) ? $creditNote->credit_note_number : generateUniqueCreditNoteNumber(), ['class' => 'form-control', 'required', 'id' => 'creditNoteNumber','readonly','placeholder'=>__('messages.credit_note.credit_note_number')]) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
        ...
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('credit_note_date', isset($creditNote->credit_note_date) ? $creditNote->credit_note_date : null, ['class' => 'form-control datepicker', 'required', 'autocomplete' => 'off','placeholder'=> __('messages.credit_note.credit_note_date')]) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
    ...
    <div class="row">
        <div class="form-group col-lg-12 col-md-12 col-sm-12 overflow-section">
            <table class="table table-responsive-sm table-responsive-md table-striped table-bordered">
                ...
                <tr>
                    <th><input type="text" name="item[]" class="form-control item-name" required placeholder="{{__('messages.invoice.item')}}"></th>
                    <td><textarea name="description[]" class="form-control item-description" placeholder="{{ __('messages.common.description')}}"></textarea></td>
                    <td><input type="text" name="quantity[]" class="form-control qty" required min="0" placeholder="{{ __('messages.invoice.qty')}}"></td>
