                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        {{ Form::label('subject',__('messages.announcement.subject').':') }}<span
                                class="required">*</span>
                        {{ Form::text('subject', null, ['class' => 'form-control','required','id' => 'editSubject','autocomplete' => 'off','placeholder'=>__('messages.announcement.subject')]) }}
                    </div>
                    <div class="form-group col-sm-12">
                        {{ Form::label('date',__('messages.announcement.announcement_date').':') }}<span
                                class="required">*</span>
                        {{ Form::text('date',null,['class' => 'form-control','id' => 'editAnnouncementDate','required','autocomplete' => 'off','placeholder'=> __('messages.announcement.announcement_date')]) }}
                    </div>
