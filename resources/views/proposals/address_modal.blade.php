            ...
            <div class="modal-body">
                ...
                <div class="row" id="addressForm">
                    ...
                    <div class="form-group col-sm-12 col-lg-6">
                        ...
                        {{ Form::text('zip_code', !empty($proposal->proposalAddresses[0]->zip_code) ? $proposal->proposalAddresses[0]->zip_code : null, ['class' => 'form-control zip-code','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'id' => 'addressZipCode']) }}
                    </div>
                    <div class="form-group col-sm-12 col-lg-6">
