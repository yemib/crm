...
@section('section')
    ...
    <div class="row">
        ...
        <div class="form-group col-md-4 col-12">
            ...
            <p>{{ Carbon\Carbon::parse($proposal->date)->translatedFormat('jS M, Y H:i A') }}</p>
        </div>
        <div class="form-group col-md-4 col-12">
            {{ Form::label('open_till', __('messages.proposal.open_till').':') }}
            <p>{{ !empty($proposal->open_till) ? Carbon\Carbon::parse($proposal->open_till)->translatedFormat('jS M, Y H:i A') : __('messages.common.n/a') }}</p>
        </div>
        <div class="form-group col-md-4 col-12">
        ...
        <div class="form-group col-md-4 col-12">
            ...
            {{ !empty($proposal->hsn_tax) ? $proposal->hsn_tax :  __('messages.common.n/a')  }}
        </div>
        <div class="form-group col-md-4 col-12">
        ...
        <div class="form-group col-md-4 col-12">
            ...
            <p><span data-toggle="tooltip" data-placement="right"
                     title="{{ Carbon\Carbon::parse($proposal->created_at)->translatedFormat('jS M, Y') }}">{{ $proposal->created_at->diffForHumans() }}</span>
            </p>
        </div>
        <div class="form-group col-md-4 col-12">
            {{ Form::label('updated_at', __('messages.common.last_updated').':') }}
            <p><span data-toggle="tooltip" data-placement="right"
                     title="{{ Carbon\Carbon::parse($proposal->updated_at)->translatedFormat('jS M, Y') }}">{{ $proposal->updated_at->diffForHumans() }}</span>
            </p>
        </div>
        <div class="col-12">
            <div class="row">
