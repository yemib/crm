...
<div class="container">
    ...
    <div class="buttons d-flex my-3 justify-content-between">
        <div class="status">
        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="invoice-date d-table float-right">
                            <div class="d-table-row">
                                ...
                                <div class="d-table-cell">{{ !empty($contract->start_date) ? Carbon\Carbon::parse($contract->start_date)->translatedFormat('jS M, Y')                                    : __('messages.common.n/a')}}</div>
                            </div>
                            <div class="d-table-row">
                                <div class="d-table-cell text-right font-weight-bold text-muted pr-1">{{ __('messages.contract.end_date').':' }}</div>
                                <div class="d-table-cell">{{ !empty($contract->end_date) ? Carbon\Carbon::parse($contract->end_date)->translatedFormat('jS M, Y') :                                        __('messages.common.n/a')}}</div>
                            </div>
                            <div class="d-table-row">
