                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 estimateDetail">
                        ...
                        <div class="invoice-date d-table float-right">
                            <div class="d-table-row">
                                ...
                                <div class="d-table-cell">{{ !empty($estimate->estimate_date) ? Carbon\Carbon::parse($estimate->estimate_date)->translatedFormat('jS M, Y') : __('messages.common.n/a')}}
                                </div>
                            </div>
                            <div class="d-table-row">
                                ...
                                <div class="d-table-cell">{{ !empty($estimate->estimate_expiry_date) ? 
                                       Carbon\Carbon::parse($estimate->estimate_expiry_date)->translatedFormat('jS M, Y') : __('messages.common.n/a')}}</div>
                            </div>
