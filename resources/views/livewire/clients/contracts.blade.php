                    ...
                    <div class="d-flex category-listing-description">
                        <div class="category-data">
                            ...
                            <h3 class="category-listing-title">
                                ...
                                &nbsp;{{ html_entity_decode(Str::limit($contract->customer->company_name,15)) }}
                                </span>
                            </h3>
                            <h3 class="category-listing-title">
                                <span data-toggle="tooltip" data-placement="top" title="{{ __('messages.common.contract_type') }}"><i
                            ...
                            @if(!empty($contract->contract_value))
                                <h3 class="category-listing-title">
                                    <span data-toggle="tooltip" title="Contract Value"><i
                                                class="{{ getCurrencyClass(getCurrentCurrency()) }} fa_fa_20px"></i>
