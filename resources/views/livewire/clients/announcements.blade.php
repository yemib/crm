        ...
        <div class="col-12 mb-3">
            <div class="hover-effect-announcement position-relative mb-4 announcement-height"
                ...
                <div class="announcement-listing-details">
                    ...
                    <div class="ml-2">
                        <span>{!! !empty($announcement->message) ? \Illuminate\Support\Str::limit($announcement->message, $limit = 150, $end = '...') : __('messages.common.n/a') !!}</span>
                    </div>
                    <div class="announcement-date-time">
                    <span data-toggle="tooltip" data-placement="right"
                          title="{{ \Carbon\Carbon::parse($announcement->date)->translatedFormat('jS M, Y') }}">{{ $announcement->date->diffForHumans() }}</span>
                    </div>
                </div>
            </div>
        </div>
