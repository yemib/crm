 <form  method="post"  action="{{ route('job.invoice')}}" >
                ...
                <div class="livewire-card card card-{{ \App\Models\Invoice::STATUS_COLOR[$invoice->payment_status] }} shadow mb-5 rounded hover-card card-height height-210">
                    <div class="card-header d-flex justify-content-between align-items-center itemCon p-3 invoice-card-height">
                        <div class="d-flex">
                            ...
                            //get the invoice bos
                            ?>
                            <input  @if(is_array($array)) @if(in_array(  $invoice->id  , $array  ) )  checked   @endif @endif  name="invoices[]"  type="checkbox"   class="form-check"   value="{{ $invoice->id }}"/>
                            @endif
                        ...
                        <div class="d-table w-100">
                            ...
                            <div>
                                ...
                                <span
                                        ...
                                        {{ html_entity_decode(Str::limit($invoice->customer->company_name,15)) }}
                                    </span>
                            </div>
                        </a>
                        <a href="{{ url('admin/invoices', $invoice->id) }}">
