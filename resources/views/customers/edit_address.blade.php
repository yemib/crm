...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1> @if(isset($_GET['new']))  Add @else Edit  @endif  {{ $customer->client_name }} Address</h1>
                           ...
                           <div class="row">
                                ...
                                <div  class="row">
                                    ...
                                    <select name="locality[1]"  id="locality" class="form-control">
                                        ...
                                        @foreach ( $data['billing_localities']  as  $billing )
                                        ...
                                        $data['billingAddress']['locality']!=null)
                                        @if($data['billingAddress']['locality']  ==   $billing)
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        {{ Form::label('zip', 'Postal Code'.':') }}
                                        {{ Form::text('zip[2]', (isset($data['shippingAddress'])
                                        ...
                                        {{-- <select  name="locality[2]" id="shippinglocality" name="shippinglocality"  class="form-control"> --}}
                                            <!-- Locality options will be populated dynamically -->
                                                ...
                                                <select name="locality[2]"  id="shippinglocality" class="form-control">
                                                    @foreach ( $data['shipping_localities']  as  $shipping )
                                                    <option 
                                                    @if (isset($data['shippingAddress']) &&
                                                    $data['shippingAddress']['locality']!=null)
                                                    @if($data['shippingAddress']['locality']  ==  $shipping)
