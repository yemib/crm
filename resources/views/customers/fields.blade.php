...
<div class="tab-content" id="myTabContent2">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6 col-sm-12">
             <label> Client Name</label> <span
                        ...
                        <input  value="{{  $customer->client_name }}"  name="client_name"   class="form-control"   id="client_name"  required/>
            </div>
    ...
    <div class="tab-pane fade" id="aForm" role="tabpanel" aria-labelledby="addressForm">
        <form  method="POST"  action="{{ route('customers.add.address' , $customer->id ) }}"  >
            @csrf
           ...
           <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        ...
                        {{ Form::select('country[1]', $data['countries'],null,
            ...
            <div class="col-md-6 col-sm-12">
                            ...
                            <label class="remove-underline" for="shippingAddressCheck">
                                <a id="copyBillingAddress" class="text-black-50 ">
                                    <input type="checkbox" id="shippingAddressCheck"
                                           class="mr-1" {{ isset($data['shippingAddress'])
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        {{ Form::label('country', 'Region'.':') }}
                        {{ Form::select('country[2]', $data['countries'],null,
...
<script>
    ...
    var map2 = L.map('in_map_shipping').setView([{{ $lat_in }}, {{ $long_in }}], 13);
    /*   var map = L.map('map').setView([51.509  , -0.08 ], 13); */
    // Add the OpenStreetMap tiles
    L.tileLayer("http://{s}.google.com/vt/lyrs=m&x={x}&y={y}&z={z}", {
        attribution: '&copy; <a target="_blank" href="https://www.google.com/maps">Google Map</a>',
