<div class="col-lg-12">
    <div class="row">
        <div class="form-group col-sm-6">
            ...
            {{ Form::text('project_name', isset($project->project_name) ? $project->project_name : null, ['class' => 'form-control', 'required','autocomplete' => 'off','placeholder'=>__('messages.project.project_name')]) }}
        </div>
        <div class="form-group col-sm-6">
            {{ Form::label('customer_id', __('messages.project.customer').':') }}<span class="required">*</span>
            {{ Form::select('customer_id', $data['customers'], isset($project->customer_id) ? $project->customer_id : $customerId, ['class' => 'form-control', 'id' => 'customersSelectBox', 'autocomplete' => 'off', 'required', 'placeholder' => __('messages.placeholder.select_customer')]) }}
        </div>
        <div class="form-group col-sm-6">
        ...
        <div class="form-group col-sm-6">
            ...
            <div class="input-group">
                ...
                {{ Form::text('estimated_hours', isset($project->estimated_hours) ? $project->estimated_hours : null, ['class' => 'form-control', 'id' => 'estimatedHours', 'autocomplete' => 'off','placeholder'=> __('messages.project.estimated_hours')]) }}
            </div>
        </div>
        <div class="form-group col-sm-6">
            ...
            <div class="input-group">
                ...
                {{ Form::text('start_date', isset($project->start_date) ? date('Y-m-d H:i:s', strtotime($project->start_date)) : null, ['class' => 'form-control', 'id' => 'startDate', 'autocomplete' => 'off', 'required','placeholder'=>__('messages.project.start_date')]) }}
            </div>
        </div>
        <div class="form-group col-sm-6">
            ...
            <div class="input-group">
                ...
                {{ Form::text('deadline',  isset($project->deadline) ? date('Y-m-d H:i:s', strtotime($project->deadline)) : null, ['class' => 'form-control', 'id' => 'deadline', 'autocomplete' => 'off', 'required','placeholder'=>__('messages.project.deadline')]) }}
            </div>
        </div>
        <div class="form-group col-sm-6">
