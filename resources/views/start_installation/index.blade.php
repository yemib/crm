...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>@if(isset($title)) {{ $title }}   @endif Projects</h1>
            <div class="section-header-breadcrumb float-right">
                <div class="card-header-action mr-3 select2-mobile-margin">
                  {{--   {{ Form::select('payment_status',$paymentStatuses,null,['id' => 'paymentStatus',
                  'class' => 'form-control','placeholder' => __('messages.placeholder.select_status')]) }} --}}
                </div>
            </div>
        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @livewire('installation-start'  ,  ['status' => $status])
