...
<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-4 col-md-6 col-sm-12">
            ...
            <select id="invoiceCurrencyId" data-show-content="true" class="form-control currency-select-box"
                ...
                <option value="0" disabled="true" {{ isset($invoice->currency) ? '' : 'selected' }}>{{__('messages.placeholder.select_currency')}}
                </option>
    ...
    <div class="row">
        <div class="form-group col-lg-6 col-md-12 col-sm-12">
            <div class="input-group">
                {{ Form::select('item', $data['items'], null, ['class' => 'form-control', 'id' => 'addItemSelectBox', 'placeholder' => __('messages.placeholder.add_product')]) }}
            </div>
        </div>
                ...
                @foreach($invoice->salesItems as $item)
                    <tr>
                        <td><input type="text" name="item[]" class="form-control item-name" required
                                   value="{{ html_entity_decode($item->item) }}" placeholder="{{ __('messages.invoice.item') }}"></td>
