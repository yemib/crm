        ...
        if ($(this).val() != '') {
            ...
            if($(this).val()  >  10){
               ...
               if(isset($invoice->id)){
                ...
                @if(isset($discount_state->id))

                @if ($discount_state->discount_approved   ==  NULL  )


                @if (auth()->user()->is_admin  ==   1 )

                @if($discount_state->is_admin  !=  1)

                $('.discount_message').html(`You need to Approve or Reject the  {{  $discount_state->discount }} %   Discount `);
                discount_approve  = true;
                ...
                @else
                discount_approve  = true;
                if($(this).val()   ==  {{ $discount_state->discount   }}  ){ 
                ...
                @if($discount_state->discount_approved  ==  1)
