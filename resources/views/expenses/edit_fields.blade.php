<div class="row">
    ...
    <div class="form-group col-sm-4">
        ...
        {{ Form::select('customer_id', $data['customers'],null, ['id'=>'customers','class' => 'form-control','placeholder' => __('messages.placeholder.select_customer')]) }}
    </div>
...
<div class="row">
    <div class="form-group col-sm-4">
        ...
        <select id="currency" data-show-content="true" class="form-control" name="currency" required>
            <option value="0" disabled="true" {{ isset($expense->currency) ? '' : 'selected' }}>{{__('messages.placeholder.select_currency')}}</option>
