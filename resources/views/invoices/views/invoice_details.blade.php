    ...
    <div class="row">
        ...
        <div class="form-group col-md-4 col-12">
            ...
            <p><a href="{{ url('admin/customers/'.$invoice->customer->id) }}"
                  class="anchor-underline">{{ html_entity_decode($invoice->customer->company_name) }} - {{ html_entity_decode($invoice->customer->client_name) }}  </a></p>
        </div>
        <div class="form-group col-md-4 col-12">
        ...
        <div class="form-group col-md-4 col-12">
            ...
            <p>{{ isset($invoice->due_date) ? (Carbon\Carbon::parse($invoice->due_date)->translatedFormat('jS M, Y')) : __('messages.common.n/a') }}</p>
        </div>
        <div class="form-group col-md-4 col-12">
