...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1> Edit  {{  $estimate_d->estimate_number }}   Estimate ({{ $estimate_d->customer->client_name }} )Address</h1>
                       ...
                       <div >
                        ...
                        <?php
                            //get the address
                                ...
                                $address_upadte  =  route('estimate.update.address' , [ $estimate_d->id ,$data['billingAddress']['id'] ] ) ;
