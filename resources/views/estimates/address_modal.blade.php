            ...
            <div class="modal-body">
                ...
                <div class="row" id="addressForm">
                    ...
                    <div class="form-group col-sm-12 col-md-6">
                        <div class="form-group col-sm-12">
                            ...
                            {{ Form::select('country[]', $data['countries'],(isset($addresses[0]->country) )?$addresses[0]->country:null,
                    ...
                    <div class="form-group col-sm-12 col-md-6">
                        ...
                        <select name="city[]"  class="form-control"  id="billCity">
                            @if(isset($addresses[0]->city))  <option> {{   $addresses[0]->city }}</option> @endif

                        </select>

                    </div>
                   {{--  <div   style="display: none" class="form-group col-sm-12 col-md-6">
                    ...
                    <div class="form-group col-sm-12 col-md-6">
                        ...
                        {{ Form::text('zip_code[]', isset($addresses[0]->zip_code) ?
                        $addresses[0]->zip_code : null, ['class' => 'form-control zip-code',
                        'id' => 'billZipCode']) }}
                    </div>
                ...
                <div id="shippingAddressForm" class="display-none">
                    ...
                    {{--     <div class="form-group col-sm-12 col-md-6">
                           ...
                           {{ Form::text('country[]', isset($addresses[1]->country) ? $addresses[1]->country
                            : null, ['id' => 'shipCountry','class' => 'form-control country']) }}
                        </div> --}}
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            <div class="form-group col-sm-12">
                                {{ Form::label('country', 'Region'.':') }}
                                {{ Form::select('country[]', $data['countries'],(isset($addresses[1]->country) )?$addresses[1]->country:null,
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                         ...
                         <select  name="city[]"  id="shipCity" class = 'form-control city'>
                          @if(isset($addresses[1]->city))  <option> {{   $addresses[1]->city  }} </option>    @endif
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            $.each(response, function(index, locality) {
              $('#billCity').append('<option value="' + locality + '">' + locality + '</option>');
            });
          }
        });
      });
      ...
      $('#shipCountry').change(function() {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            // Populate the locality dropdown with options
            $.each(response, function(index, locality) {
              $('#shipCity').append('<option value="' + locality + '">' + locality + '</option>');
            });
          }
        });
      });
