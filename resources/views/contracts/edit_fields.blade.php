<div class="row">
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="input-group">
            {{ Form::select('contract_type_id',$contractType, null, ['class' => 'form-control','required','id' => 'contractTypeId','placeholder' => __('messages.placeholder.select_contract_type')]) }}
...
<div class="row">
    <div class="form-group col-sm-6">
        ...
        {{ Form::select('customer_id',$customer, null, ['class' => 'form-control','required','id' => 'customer','placeholder' =>__('messages.placeholder.select_customer')]) }}
    </div>
    <div class="form-group col-sm-6">
...
<div class="row">
    <div class="form-group col-sm-12 col-lg-6 col-md-12">
        ...
        <div class="input-group">
            ...
            {{ Form::text('start_date', isset($contract->start_date) ? date('Y-m-d H:i:s', strtotime($contract->start_date)) : null, ['class' => 'form-control startDate','autocomplete' => 'off', 'placeholder'=> __('messages.contract.start_date')]) }}
        </div>
    </div>
    <div class="form-group col-sm-12 col-lg-6 col-md-12">
        ...
        <div class="input-group">
            ...
            {{ Form::text('end_date', isset($contract->end_date) ? date('Y-m-d H:i:s', strtotime($contract->end_date)) : null, ['class' => 'form-control endDate','autocomplete' => 'off','placeholder'=>__('messages.contract.end_date')]) }}
        </div>
    </div>
</div>
<div class="row">
