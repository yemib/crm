                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="invoice-date d-table float-right">
                            <div class="d-table-row">
                                ...
                                <div class="d-table-cell">{{ !empty($invoice->invoice_date) ? Carbon\Carbon::parse($invoice->invoice_date)->translatedFormat('jS M, Y') : __('messages.common.n/a')}}</div>
                            </div>
                            <div class="d-table-row">
                                <div class="d-table-cell text-right font-weight-bold text-muted pr-1">{{ __('messages.invoice.due_date').':' }}</div>
                                <div class="d-table-cell">{{ !empty($invoice->due_date) ? Carbon\Carbon::parse($invoice->due_date)->translatedFormat('jS M, Y') : __('messages.common.n/a')}}</div>
                            </div>
                    ...
                    <div class="col-12 mt-5">
                        <table class="table table-responsive-sm table-responsive-md table-responsive-lg table-bordered">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="text-right itemRate">{{ __('messages.products.rate') }}</th>
