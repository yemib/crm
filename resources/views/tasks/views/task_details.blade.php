...
@section('section')
    ...
    <div class="row">
        ...
        <div class="form-group col-sm-4">
            ...
            <p>{{ isset($task->start_date) ? (\Carbon\Carbon::parse($task->start_date)->translatedFormat('jS M, Y H:i A')) : __('messages.common.n/a') }}</p>
        </div>
    </div>
    <div class="row">
        <div class="form-group col-sm-4">
            ...
            @if(isset($task->due_date))
                <p>{{ \Carbon\Carbon::parse($task->due_date)->translatedFormat('jS M, Y H:i A') }}</p>
            @else
                <p>{{ __('messages.common.n/a') }}</p>
            @endif
        </div>
