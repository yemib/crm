    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <span data-toggle="tooltip" data-placement="right"
                  title="{{ \Carbon\Carbon::parse($article->created_at)->translatedFormat('jS M, Y') }}">{{ $article->created_at->diffForHumans() }}</span>
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            ...
            <br>
            <span data-toggle="tooltip" data-placement="right"
                  title="{{ \Carbon\Carbon::parse($article->updated_at)->translatedFormat('jS M, Y') }}">{{ $article->updated_at->diffForHumans() }}</span>
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
