<div class="row">
    <div class="form-group col-lg-3 col-md-6 col-sm-6">
        ...
        {{ Form::text('subject', null, ['class' => 'form-control','required','autocomplete' => 'off','placeholder'=>__('messages.article.subject')]) }}
    </div>
    <div class="form-group col-lg-3 col-md-6 col-sm-6">
        {{ Form::label('group_id', __('messages.article.group').':') }}<span class="required">*</span>
        <div class="input-group">
            {{ Form::select('group_id',$articleGroups, null, ['class' => 'form-control','required','id' => 'groupId','placeholder'=>__('messages.placeholder.select_group')]) }}
