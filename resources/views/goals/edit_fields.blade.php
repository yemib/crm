<div class="row">
    <div class="form-group col-sm-6">
        ...
        {{ Form::text('subject', null, ['class' => 'form-control','required','placeholder'=>__('messages.goal.subject')]) }}
    </div>
    <div class="form-group col-sm-6">
        {{ Form::label('goal_type', __('messages.goal.goal_type').':') }}<span class="required">*</span>
        {{ Form::select('goal_type', $goalTypes, !empty($goal->goal_type) ? $goal->goal_type : null, ['class' => 'form-control','required','placeholder' =>__('messages.placeholder.select_goal_type'), 'id' => 'editGoalTypeId']) }}
    </div>
</div>
<div class="row">
    <div class="form-group col-sm-6">
    ...
    <div class="form-group col-sm-6">
        ...
        {{ Form::number('achievement', null, ['class' => 'form-control','required','placeholder'=>__('messages.goal.achievement')]) }}
    </div>
</div>
<div class="row">
    ...
    <div class="form-group col-sm-12 col-lg-6 col-md-12">
        ...
        <div class="input-group">
            ...
            {{ Form::text('end_date', isset($goal->end_date) ? $goal->end_date : null, ['class' => 'form-control endDatepicker', 'required','autocomplete' => 'off','placeholder'=>__('messages.goal.start_date')]) }}
        </div>
    </div>
</div>
<div class="row">
