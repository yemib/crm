<div class="row">
    ...
    <div class="col-md-4 col-12">
        <div class="form-group">
            ...
            <p>{{ Carbon\Carbon::parse($goal->start_date)->translatedFormat('jS M, Y H:i A') }}</p>
        </div>
    </div>
    <div class="col-md-4 col-12">
        <div class="form-group">
            {{ Form::label('end_date', __('messages.goal.end_date').':') }}
            <p>{{ Carbon\Carbon::parse($goal->end_date)->translatedFormat('jS M, Y H:i A') }}</p>
        </div>
    </div>
    <div class="col-md-4 col-12">
        <div class="form-group">
            ...
            <span data-toggle="tooltip" data-placement="right"
                  title="{{ Carbon\Carbon::parse($goal->created_at)->translatedFormat('jS M, Y') }}">{{ $goal->created_at->diffForHumans() }}</span>
        </div>
    </div>
    <div class="col-md-4 col-12">
        <div class="form-group">
            ...
            <br>
            <span data-toggle="tooltip" data-placement="right"
                  title="{{ Carbon\Carbon::parse($goal->updated_at)->translatedFormat('jS M, Y') }}">{{ $goal->updated_at->diffForHumans() }}</span>
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
