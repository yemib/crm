<div class="row">
    ...
    <div class="form-group col-sm-6">
        ...
        {{ Form::text('first_name', null, ['class' => 'form-control','required','autocomplete' => 'off','placeholder'=> __('messages.contact.first_name')]) }}
    </div>
    <div class="form-group col-sm-6">
        {{ Form::label('last_name', __('messages.contact.last_name').':') }}
        {{ Form::text('last_name', null, ['class' => 'form-control','autocomplete' => 'off','placeholder'=> __('messages.contact.last_name')]) }}
    </div>
</div>
<div class="row">
    <div class="form-group col-sm-6">
        ...
        <span class="required">*</span>
        {{ Form::select('customer_id', $customers, isset($customerId) ? $customerId : null, ['id'=>'customerId','class' => 'form-control','placeholder' => __('messages.placeholder.select_customer'),'required']) }}
    </div>
    <div class="form-group col-sm-6">
...
<div class="row">
    <div class="form-group col-sm-6">
        ...
        <span class="required">*</span>
        {{ Form::text('email', null, ['class' => 'form-control','required','autocomplete' => 'off','placeholder'=>__('messages.common.email')]) }}
    </div>
    <div class="form-group col-sm-6">
    ...
    @if(!isset($contact))
        <div class="form-group col-sm-3">
            ...
            <div class="input-group">
                {{ Form::password('password', ['class' => 'form-control','id'=>'password','autocomplete' => 'off','required','min' => '6','max' => '10','placeholder'=>__('messages.contact.password')]) }}
