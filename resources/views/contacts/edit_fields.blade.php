<div class="row">
    ...
    <div class="form-group col-sm-6">
        ...
        {{ Form::text('first_name', $contact->user->first_name, ['class' => 'form-control','required','autocomplete' => 'off','placeholder'=>__('messages.contact.first_name')]) }}
    </div>
    <div class="form-group col-sm-6">
        {{ Form::label('last_name', __('messages.contact.last_name').':') }}
        {{ Form::text('last_name', $contact->user->last_name, ['class' => 'form-control','autocomplete' => 'off','placeholder'=>__('messages.contact.last_name')]) }}
    </div>
</div>
<div class="row">
    <div class="form-group col-sm-6">
        ...
        <span class="required">*</span>
        {{ Form::select('customer_id', $customers,null, ['id'=>'customerId','class' => 'form-control','placeholder' => __('messages.placeholder.select_customer'),'required']) }}
    </div>
    <div class="form-group col-sm-6">
...
<div class="row">
    <div class="form-group col-sm-6">
        ...
        <span class="required">*</span>
        {{ Form::text('email', $contact->user->email, ['class' => 'form-control','required','autocomplete' => 'off','placeholder'=>__('messages.common.email')]) }}
    </div>
    <div class="form-group col-sm-6">
