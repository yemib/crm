<div id="editLanguageModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="skillHeader">{{ __('messages.translator_manager.edit_language') }}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    {{ Form::hidden('language_id',null,['id' => 'languageId']) }}
